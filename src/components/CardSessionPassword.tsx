...
const CardSessionPassword = (): JSX.Element => {
    ...
    return (
        ...
        >
            {({ errors, touched, values, isValid, dirty }) => (
                <div className="cardSessionPassword">
                    <div className="text-center container container-password-phone">
                        ...
                        <div className="row">
                            <div className="mt-5 pt-3 title-phone">
                                <svg
                                    width="210"
                                    height="47"
                                    viewBox="0 0 278 64"
                        ...
                        <div className="col-md-12 mt-4">
                            <Form className="p-4">
                                <div className="d-flex mb-3">
                                    <div className="mx-4">
                                        <img
                                            src={data[3]}
                                            alt=""
                                            className="img-session-password "
                                        />
                                    </div>
                                    <div>
                                        <div className="row my-2">
                                            <span
                                                className="name-count text-start"
                                                style={{
                                                    fontWeight: '500',
                                                }}
                                            >
                                            ...
                                            <span className="email-text text-start mt-2">
                                                {data[2]}
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <InputPassword
                                            ...
                                            classCustom={
                                                ...
                                                'Error al iniciar sesión'
                                                    ? 'alert-input-danger border-session-valid mt-2'
                                                    : values.password?.length >
                                                      0
                                                    ? 'border-email border-password-valid mt-2'
                                                    : 'border-email mt-2 text-dark input-password-phone'
                                            }
                                ...
                                touched.password != null ? (
                                    ...
                                    <>
                                        <div
                                            className="text-start position-absolute mx-4 px-2 mt-1"
                                            style={{
                                ...
                                <div className="d-flex justify-content-end">
                                    <a
                                        onClick={openRecoveryPasswordModal}
                                        className="mx-4 btn p-0 border-0 mt-1"
                                        style={{
                                ...
                                <button
                                    type="submit"
                                    className={`btn btn-lg mt-3 btn-password ${
...
export default CardSessionPassword
