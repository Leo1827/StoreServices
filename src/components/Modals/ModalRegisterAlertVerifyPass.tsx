import CardNotificationRecovery from '../CardNotificationRecovery'
import ModalWithBlur from '../ModalWithBlur'

interface ModalRegisterAlertVerifyPassI {
    openModal: boolean
}

const ModalRegisterAlertVerifyPass = ({
    openModal,
}: ModalRegisterAlertVerifyPassI): JSX.Element => {
    const imgTitle = (
        <svg
            width="86"
            height="87"
...
export default ModalRegisterAlertVerifyPass
